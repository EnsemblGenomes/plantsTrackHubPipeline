...
#test30
like($super_track_obj->{metadata}, qr/hub_created_date=\".+\" biosample_id=SAMD00008650 germline=N description=\"Total mRNAs from callus, leaf, panicle before flowering, panicle after flowering, root, seed, and shoot of rice \(Oryza sativa ssp. Japonica cv. Nipponbare\)\" accession=SAMD00008650 environmental_sample=N scientific_name=\"Oryza sativa Japonica Group\" sample_alias=SAMD00008650 tax_id=39947 center_name=BIOSAMPLE secondary_sample_accession=DRS000668 first_public=2011-12-21/,"super track metadata string is as expected");
